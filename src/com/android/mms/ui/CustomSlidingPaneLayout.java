...
//            dispatchOnPanelSlide(mSlideableView);
//            mPreservedOpenState = true;
//            onPanelDragged(mSlideRange);
//            requestLayout();
//            this.getChildAt(0).offsetLeftAndRight(-mSlideRange);
        }
    }
...
////            parallaxOtherViews(mSlideOffset);
////            dispatchOnPanelClosed(mSlideableView);
////            dimChildView(mSlideableView, 1 - mParallaxOffset, mCoveredFadeColor);
//        }
////        requestLayout();
////        invalidate();
//        mPreservedOpenState = false;
